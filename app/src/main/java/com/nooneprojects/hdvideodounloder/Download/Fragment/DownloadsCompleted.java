...
import com.nooneprojects.hdvideodounloder.Adapter.SavedAdapter;
...
public class DownloadsCompleted extends VDFragment implements DownloadsInProgress.OnAddDownloadedVideoToCompletedListener{
    ...
    private com.hurricaneDev.videoDownloader.download.list.CompletedVideos completedVideos;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        completedVideos = com.hurricaneDev.videoDownloader.download.list.CompletedVideos.load(getActivity());
    ...
    public void onAddDownloadedVideoToCompleted(final String name, final String type) {
        if (completedVideos == null) {
            completedVideos = new com.hurricaneDev.videoDownloader.download.list.CompletedVideos();
        }
